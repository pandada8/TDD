...
describe("战斗吧少年！",function(){
    ...
    it("测试Log_普通人攻击有盾战士", function(){
        ...
        var B = new game.model.Hero('李四', 40, 20, {},{name: "盾", value: 10}) ;
        var fight = new game.Fight(A, B, logger);
        fight.start()
        expect(logger.logs.join('|')).toBe("普通人张三攻击了战士李四,李四受到了10点伤害, 李四的剩余生命值30|战士李四攻击了普通人张三,张三受到了20点伤害, 张三的剩余生命值80|普通人张三攻击了战士李四,李四受到了10点伤害, 李四的剩余生命值20|战士李四攻击了普通人张三,张三受到了20点伤害, 张三的剩余生命值60|普通人张三攻击了战士李四,李四受到了10点伤害, 李四的剩余生命值10|战士李四攻击了普通人张三,张三受到了20点伤害, 张三的剩余生命值40|普通人张三攻击了战士李四,李四受到了10点伤害, 李四的剩余生命值0|张三胜利")
    })
    it("测试Log_普通人攻击有剑战士", function(){
        var A = new game.model.Player('张三', 100, 20);
        var B = new game.model.Hero('李四', 40, 20, {name:"木剑", value: 10}) ;
        var fight = new game.Fight(A, B, logger);
        fight.start()
        expect(logger.logs.join('|')).toBe("普通人张三攻击了战士李四,李四受到了20点伤害, 李四的剩余生命值20|战士李四用木剑攻击了普通人张三,张三受到了30点伤害, 张三的剩余生命值70|普通人张三攻击了战士李四,李四受到了20点伤害, 李四的剩余生命值0|张三胜利");
    })
